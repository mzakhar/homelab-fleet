...
- 2026-07-20: Moved Homepage Observability and Actions above GitHub in dashboard order; replaced public GitHub repo star counts with open PR counts while keeping private repo cards on stable REST Issues/Pushed metrics to avoid GraphQL permission gaps.
